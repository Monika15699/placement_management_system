...
body{
   ...
   background:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(images/Adminlogin.jpeg);
...
<form name="myform" class="box" action="http://localhost:8069/PlacementManagement/Admi_portal.jsp" method="post" onsubmit="return validateform()">
<h1>
 Admin Login!!
</h1>
